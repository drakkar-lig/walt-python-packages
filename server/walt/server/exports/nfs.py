...
EXPORTS_D_PATH = Path("/etc/exports.d")
WALT_EXPORTS_PATH = EXPORTS_D_PATH / "walt.exports"
...
def clear_conf():
    # WALT older versions had several conf files
    for f in EXPORTS_D_PATH.glob("walt*.exports"):
        f.unlink()
