...
class SSAPI(APISession):
    ...
    @api_expose_method
    def register_fake_device(self, context, *args, **kwargs):
        return context.server.register_fake_device(
                context.requester, *args, **kwargs)
    ...
    def get_exports_info(self, context):
        return context.server.exports.get_exports_info()
