...
class VMParameters:
    ...
    def disks(self, disks_value):
        ...
        self.qemu_disks_args = get_qemu_disks_args(
                self.disks_path, parsing[1])
    ...
    def networks(self, networks_value):
        ...
        self.qemu_networks_args = get_qemu_networks_args(
                self.mac, self.hostid, self.networks_path, parsing[1])
